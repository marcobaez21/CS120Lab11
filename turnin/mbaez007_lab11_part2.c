...
int LEDSM3(int states3){
	switch(states3){
		case InitFest3:
			led3=0;
			if(go==3){count3=0;states3=StartFest3;}
			else{states3=InitFest3;}
			break;
		case StartFest3:
			if(go==3){states3=StartFest3;}
			else{states3=InitFest3;}
			break;
		default:
			break;
...
int LEDsSM(int state2){
	...
	switch(state2){
		case LEDInit:
			break;
		case LEDStart:
			if(go==1){transmit_data(led);}
			else if(go==2){transmit_data(led2);}
			else if (go==3){transmit_data(led3);}
			else if(go==0){transmit_data(0);}
			break;
		default:
			break;
	}
